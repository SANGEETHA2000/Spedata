...
<body>
    ...
    <h3>Choose your Post Paid plan</h3>
    </div>
        <?php
                $dbhost='localhost';
                $username='root';
    ...
    <div class="prising_area">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-100">
                        ...
                        <h4>
                            Pay only at the end of 30 days for any plan
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <?php
                ...
                for( $i = 0; $i<$itr; $i++ )
                {
                    $result = mysqli_query($connection,"SELECT * FROM postpaid LIMIT $i,1");
                    if(!$result)
                    {
                        echo('error :::: '.mysqli_error($connection));
                    }
