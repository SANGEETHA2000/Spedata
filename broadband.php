...
<body>
    ...
    <h3>Choose your Broad Band plan</h3>
    </div>
        <?php
                $dbhost='localhost';
                $username='root';
    ...
    <div class="prising_area">
        <div class="container">
            ...
            <?php
                ...
                for( $i = 0; $i<$itr; $i++ )
                {
                    $result = mysqli_query($connection,"SELECT * FROM broadband LIMIT $i,1");
                    if(!$result)
                    {
                        echo('error :::: '.mysqli_error($connection));
                    }
                    else
                    {
                        ...
                        echo $temp['Amount'],' /-';
                        echo '</span></p>';
                        echo '<a href="#test-form" class="boxed_btn_green2 login popup-with-form">Get plan</a></div></div>';
                    }
                }
            ?>
            </div>
