        ...
        <div class="container">
            ...
            <div class="row mb-60">
                <div class="col-xl-6">
                    <p>Office Address:<br>
                        Spedata Limited,<br>
                        Plot No. 64, V.M.Chathira Road, Thiyagarajanagar,<br>
                        Tirunelveli - 627 011 India</p>
                </div>
                <div class="col-xl-6">
                    <p>Registered Address:<br>
                        Spedata Limited,<br>
                        Plot No. 18, Street no. 11, Sai Baba Colony,<br>
                        Coimbatore - 624 001 India<br>
                        Contact Number : +1234 567 890</p>
                </div>
            </div>
        </div>
    </div>
